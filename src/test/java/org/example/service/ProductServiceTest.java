...
class ProductServiceTest {
    ...
    public void testThatProductCanBeCreated() {
        ...
        Product product1 = productServiceImpl.createProduct("productName", "description", 80.00, "category", "imageUrl",
                LocalTime.of(2, 4, 0),
                LocalTime.of(2, 4, 59));
    ...
    public void testThatProductDetailsCanBeUpdated(){
        ...
        Product product1 = productServiceImpl.updateProduct("productName", "description", 80.00, "category", "imageUrl",
                LocalTime.of(2, 1, 0),
                LocalTime.of(2, 2, 59));
    ...
    public void testThatProductCanBeDeleted(){
        ...
        Product product1 = productServiceImpl.delectProduct("productName", "description", 80.00, "category", "imageUrl",
                LocalTime.of(2, 1, 5),
                LocalTime.of(2, 2, 3));
